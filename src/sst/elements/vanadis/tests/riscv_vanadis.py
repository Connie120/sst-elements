...
verbosity = int(os.getenv("VANADIS_VERBOSE", 1))
...
#       "executable" : "./tests/test-fp",
       ...
       "executable" : os.getenv("VANADIS_EXE", "../tests/small/basic-io/hello-world_riscv_musl"),
       #"executable" : os.getenv("VANADIS_EXE", "./tests/riscv/test.x"),
       #"executable" : os.getenv("VANADIS_EXE", "./tests/riscv/basic_musl"),
       #"executable" : os.getenv("VANADIS_EXE", "./tests/riscv/pthread_musl"),
       "app.env_count" : 2,
